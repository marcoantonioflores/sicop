...
<p style="background-color: #ffffff; width: 20px;"> </p>
...
<img src="https://user-images.githubusercontent.com/54905076/214949577-a0c540a6-c686-41ed-bbf8-7820473377ea.png" alt="imagen de ejemplo" width="200">  
 ...
 <div style="position: absolute;background-color: #ffffff; height: 100%; display: flex; text-align: center;padding-bottom: 20px;width:100%;">
  <span style="font-family: 'Acre-Medium';top: 0;bottom: 0;font-size: 11pt;">fuente: INEGI</span>
 </div>
